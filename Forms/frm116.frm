...
Begin VB.Form frm116 
   Caption         =   "Goods Received Note (GRN)"
   ClientHeight    =   13035
   ClientLeft      =   120
   ClientTop       =   465
   ClientWidth     =   23760
   ...
   Begin VB.CommandButton CMD22 
      ...
      Left            =   8760
      MaskColor       =   &H00400000&
      MouseIcon       =   "frm116.frx":0614
      MousePointer    =   99  'Custom
      Picture         =   "frm116.frx":091E
      Style           =   1  'Graphical
      TabIndex        =   91
   ...
   Begin VB.CommandButton CMD21 
      ...
      Left            =   7560
      MaskColor       =   &H00400000&
      MouseIcon       =   "frm116.frx":1244
      MousePointer    =   99  'Custom
      Picture         =   "frm116.frx":154E
      Style           =   1  'Graphical
      TabIndex        =   90
   ...
   Begin VB.ComboBox CBB4 
      ...
      Enabled         =   0   'False
      Height          =   360
      ItemData        =   "frm116.frx":27AB
      Left            =   12240
      List            =   "frm116.frx":27AD
      Style           =   2  'Dropdown List
      TabIndex        =   54
      Top             =   7755
      Width           =   4215
   ...
   Begin VB.ComboBox CBB2 
      BackColor       =   &H00FFFFFF&
      Height          =   360
      ItemData        =   "frm116.frx":27AF
      Left            =   12240
      List            =   "frm116.frx":27B1
      Style           =   2  'Dropdown List
      TabIndex        =   9
      Top             =   6720
      Width           =   4215
   ...
   Begin VB.Label Label41 
      BackStyle       =   0  'Transparent
      Caption         =   "Senarai barang yang diterima."
      BeginProperty Font 
         Name            =   "Tahoma"
         Size            =   9.75
         Charset         =   0
   ...
   Begin VB.Label Label3 
      BackStyle       =   0  'Transparent
      Caption         =   "Sila masukkan maklumat terperinci barang yang diterima dari supplier / agen."
      BeginProperty Font 
         Name            =   "Tahoma"
         Size            =   9.75
         Charset         =   0
   ...
   Begin VB.Label Label14 
      ...
      Width           =   2295
   End
   Begin VB.Menu frm116_pm_menu 
      Caption         =   "Menu"
      Visible         =   0   'False
      Begin VB.Menu frm116_sm_edit_data 
         Caption         =   "Edit data"
      End
      Begin VB.Menu frm116_sm_spacer1 
         Caption         =   "-"
      End
      Begin VB.Menu frm116_sm_remove 
         Caption         =   "Keluarkan dari senarai / Padam"
      End
   End
End
Attribute VB_Name = "frm116"
...
Dim Frm116_LM_BERAT_BELIAN_9999 As Double

Frm116_LM_HARGA_SEMASA = 0
Frm116_LM_BERAT_BELIAN_9999 = 0
LM_KADAR_TUKARAN = 0
x = 0

If frm116.CBB1 = vbNullString Then
    x = x + 1
    Err(x) = "Sila buat pilihan [Purity]."
End If
If frm116.TB1 = vbNullString Or (frm116.TB1 <> vbNullString And Not IsNumeric(frm116.TB1)) Then
    x = x + 1
    Err(x) = "Sila masukkan [Berat Asal (g)]. Hanya NOMBOR dibenarkan dalam ruangan ini."
End If
If frm116.TB2 = vbNullString Or (frm116.TB2 <> vbNullString And Not IsNumeric(frm116.TB2)) Then
    x = x + 1
    Err(x) = "Sila masukkan [Kadar Tukaran Mutu]. Hanya NOMBOR dibenarkan dalam ruangan ini."
End If
If frm116.TB6 = vbNullString Or (frm116.TB6 <> vbNullString And Not IsNumeric(frm116.TB6)) Then
    x = x + 1
    Err(x) = "Sila masukkan [Harga Semasa Emas 999.9]. Hanya NOMBOR dibenarkan dalam ruangan ini."
End If
If (frm116.TB2 <> vbNullString And IsNumeric(frm116.TB2)) Then
    
    LM_KADAR_TUKARAN = frm116.TB2
...
End If
If frm116.TB3 = vbNullString Or (frm116.TB3 <> vbNullString And Not IsNumeric(frm116.TB3)) Then
    x = x + 1
    Err(x) = "Sila masukkan [Upah]. Hanya NOMBOR dibenarkan dalam ruangan ini."
End If
If frm116.CB2 = 0 And frm116.CB3 = 0 And frm116.CB4 = 0 Then
    x = x + 1
    Err(x) = "Sila buat pilihan jenis GST bagi upah."
End If
If frm116.TB4 = vbNullString Or frm116.TB5 = vbNullString Then
    x = x + 1
...
'### Masukkan Data Ke Dalam Temp Table ### - Start
        ...
        rs.AddNew
        If frm116.CBB1 <> vbNullString Then 'Purity
            rs!purity = frm116.CBB1
        Else
            rs!purity = Null
        End If
        If frm116.TB1 <> vbNullString Then 'Berat Asal
            rs!Berat_Asal = Format(frm116.TB1, "0.00")
        Else
            rs!Berat_Asal = Null
        End If
        If frm116.TB2 <> vbNullString Then 'Kadar Tukaran
            rs!kadar_tukaran = frm116.TB2
        Else
            rs!kadar_tukaran = Null
        End If
        If frm116.L1_Text <> vbNullString Then 'Berat Selepas Tukaran
            rs!berat_tukaran_grn = Format(frm116.L1_Text, "0.00")
        Else
            rs!berat_tukaran_grn = Null
        End If
        If frm116.TB3 <> vbNullString Then
            rs!UPAH = Format(frm116.TB3, "0.00") 'Upah (RM)
        Else
            rs!UPAH = Null 'Upah (RM)
        End If
        If frm116.L30_Text <> vbNullString Then 'Harga upah tanpa GST
            rs!harga_tanpa_gst_grn = Format(frm116.L30_Text, "0.00")
        Else
            rs!harga_tanpa_gst_grn = Null
        End If
        If frm116.TB4 <> vbNullString Then 'Jumlah GST
            rs!jumlah_gst = Format(frm116.TB4, "0.00")
        Else
            rs!jumlah_gst = Null
        End If
        If frm116.L22_Text <> vbNullString Then 'Kadar GST
            rs!kadar_gst = Format(frm116.L22_Text, "0.00")
        Else
            rs!kadar_gst = Null
        End If
        If frm116.TB5 <> vbNullString Then 'Jumlah Upah + GST
            rs!harga_dengan_gst_grn = Format(frm116.TB5, "0.00")
        Else
            rs!harga_dengan_gst_grn = Null
        End If
        If frm116.CB2 = 1 Then
            rs!gst_ari_nashi = "ZR" '0 : Tiada GST : ZR(L) , 1 : Ada GST : SR
        ElseIf frm116.CB3 = 1 Or frm116.CB4 = 1 Then
            rs!gst_ari_nashi = "SR" '0 : Tiada GST : ZR(L) , 1 : Ada GST : SR
            If frm116.CB4 = 1 Then 'Jenis Cukai GST SR
        ...
        Frm116_LM_HARGA_SEMASA = frm116.TB6 'Harga emas semasa 999.9 (Untuk tujuan belian dari agen)
        Frm116_LM_BERAT_BELIAN_9999 = frm116.L1_Text 'Berat belian dalam purity 999.9
        
        rs!nilaian_harga_emas = Format(Frm116_LM_HARGA_SEMASA * Frm116_LM_BERAT_BELIAN_9999, "0.00")
        rs!Status = 1
        rs.Update
        Frm116_LM_DATA_SAVE = 1
        
        rs.Close
        Set rs = Nothing
'### Masukkan Data Ke Dalam Temp Table ### - End

        If Frm116_LM_DATA_SAVE = 1 Then
...
Dim Frm116_LM_CUKAI_ZR As Double
Dim Frm116_LM_CUKAI_SR As Double
Dim Frm116_LM_BERAT_ASAL As Double
Dim Frm116_LM_BERAT_JUALAN As Double
Dim LM_KADAR_TUKARAN As Double

LM_KADAR_TUKARAN = 0
Frm116_LM_KATEGORI = 0
Frm116_LM_BERAT_ASAL = 0 'Berat Asal (g)
Frm116_LM_BERAT_JUALAN = 0 'Berat Jualan (g)
Frm116_LM_CUKAI_ZR = 0 'Jumlah cukai GST ZR
Frm116_LM_CUKAI_SR = 0 'Jumlah cukai GST SR

Frm116_LM_Flag_SIMPANAN = 0 '0 : Tiada Penggunakan Duit Simpanan Kedai , 1 : Ada Penggunakan Duit Simpanan Kedai

If frm116.L71_Text = vbNullString Then
    x = x + 1
    Err(x) = "Tiada maklumat ID data yang ingin diedit. Sila keluar dari menu ini dan cuba sekali lagi."
End If
If frm116.L43_Text = "0" Then
    x = x + 1
    Err(x) = "Tiada senarai belian/penerimaan barang."
End If
If frm116.CBB2 = vbNullString Then
    x = x + 1
    Err(x) = "Sila pilih supplier/agen yang membuat belian ini."
End If
If frm116.CBB4 = vbNullString Then
    x = x + 1
    Err(x) = "Sila pilih nama pekerja."
End If
If frm116.TB8 = vbNullString Or (frm116.TB8 <> vbNullString And Not IsNumeric(frm116.TB8)) Then
    x = x + 1
    Err(x) = "Sila masukkan [Kadar Tukaran Purity 999.9]. Hanya NOMBOR dibenarkan dalam ruangan ini."
End If
If (frm116.TB8 <> vbNullString And IsNumeric(frm116.TB8)) Then
    
    LM_KADAR_TUKARAN = frm116.TB8
...
End If
If frm116.TB9 <> vbNullString Then

    If InStr(1, frm116.TB9, "*") <> 0 Or InStr(1, frm116.TB9, "/") <> 0 Or InStr(1, frm116.TB9, "\") <> 0 Or InStr(1, frm116.TB9, "'") <> 0 Then
...
Else
    ...
    If Answer = vbYes Then
        ...
        If frm116.CBB4 <> vbNullString Then
            ...
            Frm116_LM_EMP_NAMA = Split(frm116.CBB4, "  |  ")(0)
            Frm116_LM_EMP_NO = Split(frm116.CBB4, "  |  ")(1)
...
'### Masukkan maklumat Good Delivery Note (GRN) ### - Start
        ...
        Set rs = New ADODB.Recordset
        If (MDI_frm1.L17_Text = "ONLINE" Or G_SYSTEM_TYPE = "OFFLINE") Then Call check_db_conn_main Else Exit Sub
        rs.Open "select * from 77_gdn_grn where ID='" & frm116.L71_Text & "' AND status = 1", cn, adOpenKeyset, adLockOptimistic
        ...
        If Not rs.EOF Then
            ...
            If frm116.L48_Text <> vbNullString Then 'Berat asal sebelum tukaran mutu
                rs!Berat_Asal = Format(frm116.L48_Text, "0.00")
            Else
                rs!Berat_Asal = "0.00"
            End If
            If frm116.TB8 <> vbNullString Then
                rs!kadar_tukaran = frm116.TB8
            Else
                rs!kadar_tukaran = "0.00"
            End If
            If frm116.L9_Text <> vbNullString Then
                rs!berat_tukaran_grn = Format(frm116.L9_Text, "0.00")
            Else
                rs!berat_tukaran_grn = Null
            End If
            If frm116.L51_Text <> vbNullString Then
                rs!harga_tanpa_gst = Format(frm116.L51_Text, "0.00")
            Else
                rs!harga_tanpa_gst = "0.00"
            End If
            If frm116.L52_Text <> vbNullString Then
                rs!jumlah_gst = Format(frm116.L52_Text, "0.00")
            Else
                rs!jumlah_gst = "0.00"
            End If
            If frm116.L22_Text <> vbNullString Then
                rs!kadar_gst = Format(frm116.L22_Text, "0.00")
            Else
                rs!kadar_gst = "0.00"
            End If
            If frm116.L53_Text <> vbNullString Then
                rs!harga_dengan_gst_grn = Format(frm116.L53_Text, "0.00")
            Else
                rs!harga_dengan_gst_grn = Null
            End If
            If frm116.TB6 <> vbNullString Then
                rs!harga_999 = Format(frm116.TB6, "0.00")
            Else
                rs!harga_999 = "0.00"
            End If
            If frm116.L12_Text <> vbNullString Then
                rs!nilaian_harga_emas = Format(frm116.L12_Text, "0.00")
            Else
                rs!nilaian_harga_emas = "0.00"
            End If
            If frm116.L17_Text <> vbNullString Then
                rs!gst_zr_harga = Format(frm116.L17_Text, "0.00")
            Else
                rs!gst_zr_harga = "0.00"
            End If
            If frm116.L18_Text <> vbNullString Then
                rs!gst_sr_harga = Format(frm116.L18_Text, "0.00")
            Else
                rs!gst_sr_harga = "0.00"
            End If
            If frm116.L19_Text <> vbNullString Then
                rs!gst_zr_cukai = Format(frm116.L19_Text, "0.00")
            Else
                rs!gst_zr_cukai = "0.00"
            End If
            If frm116.L20_Text <> vbNullString Then
                rs!gst_sr_cukai = Format(frm116.L20_Text, "0.00")
            Else
                rs!gst_sr_cukai = "0.00"
            End If
            If frm116.L43_Text <> vbNullString Then
                rs!bil_barang = frm116.L43_Text
            Else
                rs!bil_barang = 0
            End If
            If frm116.TB9 <> vbNullString Then
                rs!no_rujukan_supplier = UCase(frm116.TB9)
            Else
            ...
            If frm116.CBB2 <> vbNullString Then
                rs!supplier_agen = frm116.CBB2
            Else
                rs!supplier_agen = Null
            End If
            rs!user = Frm116_LM_EMP_NAMA 'Nama Pekerja
            rs.Update
            DATA_SAVE = 1
...
'### Masukkan Data Jualan Ke Dalam Table Jualan ### - Start
        ...
        If DATA_SAVE = 1 Then
            ...
            strsql = "insert into 79_grn(tarikh,masa,write_timestamp,no_rujukan,no_rujukan_rev,purity,berat_asal," _
                        ...
                        "select '" & frm116.DTPicker1 & "','" & LM_MASA & "','" & LM_NOW & "','" & LM_NO_RUJUKAN & "','" & LM_NO_RUJUKAN_REV & "',purity,berat_asal," _
                        & "berat_tukaran_grn,upah,harga_tanpa_gst_grn,gst_ari_nashi," _
                        & "gst_include,jumlah_gst,kadar_gst,harga_dengan_gst_grn,nilaian_harga_emas," _
                        & "kadar_tukaran,1,0,'" & G_TERMINAL & "','" & LM_CAWANGAN & "','" & Frm116_LM_EMP_NAMA & "'" _
                        & "from " & G_GRN_TEMP & ""
    ...
    '#### Update Log Aktiviti Sistem #### - Start
            ...
            LogAct_Memory = "[" & Frm116_LM_EMP_NAMA & "] Edit/revise data GRN kepada agen/supplier. No. Rujukan [" & LM_NO_RUJUKAN & "][" & LM_NO_RUJUKAN_REV & "]."
    ...
    '#### Update Log Aktiviti Sistem #### - End
            ...
            MsgBox "Data GRN telah berjaya diedit/revise.", vbInformation, "Info"
...
If frm116.L24_Text = vbNullString Or (frm116.L24_Text <> vbNullString And frm116.L24_Text = 0) Then
    x = x + 1
...
'### Masukkan Data Ke Dalam Temp Table ### - Start
        Set rs = New ADODB.Recordset
        If (MDI_frm1.L17_Text = "ONLINE" Or G_SYSTEM_TYPE = "OFFLINE") Then Call check_db_conn_main Else Exit Sub
        rs.Open "select * from " & G_GRN_TEMP & " where ID='" & frm116.L24_Text & "'", cn, adOpenKeyset, adLockOptimistic
        ...
        If Not rs.EOF Then
            ...
            rs!nilaian_harga_emas = Format(Frm116_LM_HARGA_SEMASA * Frm116_LM_BERAT_BELIAN_9999, "0.00")
            If frm116.L32_Text = "0" Then '0 : Menu Data Baru , 1 : Menu Edit Data
                rs!Status = 1
            ElseIf frm116.L32_Text = "1" Then
                If rs!Status = "2" Then
                    rs!Status = 3
                End If
                If rs!Status = "4" Then
...
'on error resume next
Dim Frm116_LM_CURR_PAGE As Double
Dim Frm116_LM_TOTAL_PAGE As Double

Frm116_LM_CURR_PAGE = 0
...
If frm116.L67_Text <> vbNullString And IsNumeric(frm116.L67_Text) Then
    If frm116.L68_Text <> vbNullString And IsNumeric(frm116.L68_Text) Then
        ...
        If Frm116_LM_CURR_PAGE <> 1 And Frm116_LM_CURR_PAGE <> 0 Then
...
' ### Periksa No. GRN ### - Start
        ...
        If Not rs.EOF Then
            ...
            If Not IsNull(rs!no_grn) Then
                If IsNumeric(rs!no_grn) Then LM_NO_GRN = rs!no_grn 'No. GRN
            End If
...
Re_gen_no_resit:
        ...
        Set rs = New ADODB.Recordset
        If (MDI_frm1.L17_Text = "ONLINE" Or G_SYSTEM_TYPE = "OFFLINE") Then Call check_db_conn_main Else Exit Sub
        rs.Open "select * from 77_gdn_grn where no_rujukan='" & "GRN" & G_TAHUN & "-" & G_KOD_KEDAI & "-" & Format(LM_NO_GRN, "000000") & "' AND jenis_urusan = 1", cn, adOpenKeyset, adLockOptimistic
        
        If Not rs.EOF Then
        
            LM_NO_GRN = LM_NO_GRN + 1
...
'---------------------------------------No. Invoice
        ...
        rs.Open "select * from 7_grn", cn2, adOpenKeyset, adLockOptimistic
        ...
        Set rs = New ADODB.Recordset
        If (MDI_frm1.L17_Text = "ONLINE" Or G_SYSTEM_TYPE = "OFFLINE") Then Call check_db_conn_main3 Else Exit Sub
        rs.Open "select * from 7_grn where nama_staff='" & MDI_frm1.L3_Text & "' AND terminal='" & G_TERMINAL & "' AND write_timestamp='" & LM_NOW & "' AND tarikh='" & frm116.DTPicker1 & "' AND status = 1 order by ID DESC", cn2, adOpenKeyset, adLockOptimistic
        ...
        If Not rs.EOF Then
            ...
            If Not IsNull(rs!ID) Then
                ...
                LM_NO_GRN = rs!ID
                rs!no_rujukan = "GRN" & G_TAHUN & "-" & G_KOD_KEDAI & "-" & Format(LM_NO_GRN, "000000")
...
Re_gen_no_resit2:
        ...
        If rs.EOF Then
            ...
            rs!no_rujukan = "GRN" & G_TAHUN & "-" & G_KOD_KEDAI & "-" & Format(LM_NO_GRN, "000000")
            rs!Revision = 0
            rs!no_rujukan_rev = "GRN" & G_TAHUN & "-" & G_KOD_KEDAI & "-" & Format(LM_NO_GRN, "000000")
            G_No_RESIT_JUALAN = "GRN" & G_TAHUN & "-" & G_KOD_KEDAI & "-" & Format(LM_NO_GRN, "000000")
...
'### Masukkan Data Jualan Ke Dalam Table Jualan ### - Start
        ...
        If DATA_SAVE = 1 Then
            ...
            strsql = "insert into 79_grn(tarikh,masa,write_timestamp,no_rujukan,no_rujukan_rev,purity,berat_asal," _
                        ...
                        & "gst_include,jumlah_gst,kadar_gst,harga_dengan_gst_grn,nilaian_harga_emas," _
                        & "kadar_tukaran,Status,flag_urusan,terminal,cawangan,user)" & _
                        "select '" & frm116.DTPicker1 & "','" & LM_MASA & "','" & LM_NOW & "','" & G_No_RESIT_JUALAN & "','" & G_No_RESIT_JUALAN & "',purity,berat_asal," _
                        & "berat_tukaran_grn,upah,harga_tanpa_gst_grn,gst_ari_nashi," _
                        & "gst_include,jumlah_gst,kadar_gst,harga_dengan_gst_grn,nilaian_harga_emas," _
                        & "kadar_tukaran,1,0,'" & G_TERMINAL & "','" & G_KEDAI & "','" & Frm116_LM_EMP_NAMA & "'" _
    ...
    '#### Update Log Aktiviti Sistem #### - Start
            'User = MDI_frm1.L3_Text
            LogAct_Memory = "[" & Frm116_LM_EMP_NAMA & "] Pengeluaran GRN kepada agen/supplier. No. Rujukan [" & G_No_RESIT_JUALAN & "]."
            LogDate_Memory = LM_NOW
            Call UpdateLog_Database
    '#### Update Log Aktiviti Sistem #### - End
...
Private Sub frm116_sm_edit_data_Click()
'on error resume next
DATA_FOUND = 0
Frm116_LM_No_ID = vbNullString

If frm116.MSFlexGrid1 <> vbNullString Then

    If IsNumeric(frm116.MSFlexGrid1) Then
    
        Frm116_LM_No_ID = frm116.MSFlexGrid1.TextMatrix(frm116.MSFlexGrid1, 2) 'No. ID
        
        If Frm116_LM_No_ID <> vbNullString Then
        
            Call frm116_reset_1 '!! Hati-hati dengan tempat letakkan command ini!!
            
            Set rs = New ADODB.Recordset
            If (MDI_frm1.L17_Text = "ONLINE" Or G_SYSTEM_TYPE = "OFFLINE") Then Call check_db_conn_main Else Exit Sub
            rs.Open "select * from " & G_GRN_TEMP & " where ID='" & Frm116_LM_No_ID & "'", cn, adOpenKeyset, adLockOptimistic
            
            If Not rs.EOF Then
            
                If Not IsNull(rs!ID) Then frm116.L24_Text = rs!ID 'No. ID Database
                If Not IsNull(rs!Berat_Asal) Then frm116.TB1 = Format(rs!Berat_Asal, "#,##0.00") 'Berat Asal
                If Not IsNull(rs!kadar_tukaran) Then frm116.TB2 = rs!kadar_tukaran 'Kadar Tukaran
                If Not IsNull(rs!berat_tukaran_grn) Then frm116.L1_Text = Format(rs!berat_tukaran_grn, "#,##0.00") 'Berat Selepas Tukaran
                If Not IsNull(rs!kadar_gst) Then frm116.L22_Text = rs!kadar_gst 'Kadar GST
                If Not IsNull(rs!UPAH) Then frm116.TB3 = Format(rs!UPAH, "#,##0.00") 'Upah (RM)
                If Not IsNull(rs!harga_tanpa_gst_grn) Then frm116.L30_Text = Format(rs!harga_tanpa_gst_grn, "#,##0.00") 'Harga upah tanpa GST
                If Not IsNull(rs!jumlah_gst) Then frm116.TB4 = Format(rs!jumlah_gst, "#,##0.00") 'Jumlah GST
                If Not IsNull(rs!harga_dengan_gst_grn) Then frm116.TB5 = Format(rs!harga_dengan_gst_grn, "#,##0.00") 'Jumlah Upah + GST

                If Not IsNull(rs!gst_ari_nashi) Then 'Harga Jualan (RM)
                    If rs!gst_ari_nashi = "ZR" Then
                        frm116.CB2 = 1 '0 : Tiada GST : ZR(L) , 1 : Ada GST : SR
                    ElseIf rs!gst_ari_nashi = "SR" Then
                        frm116.CB3 = 1 '0 : Tiada GST : ZR(L) , 1 : Ada GST : SR
...
Restore_A:
            ...
            If DATA_FOUND = 1 Then
                frm116.CMD1.Visible = False
                frm116.CMD2.Visible = True
                frm116.CMD3.Visible = True
            End If
...
Exit Sub
Err_A:
frm116.CBB1.AddItem Frm115_LM_MAKLUMAT_PEKERJA
frm116.CBB1 = Frm115_LM_MAKLUMAT_PEKERJA
Resume Restore_A:
End Sub
Private Sub frm116_sm_remove_Click()
'on error resume next
DATA_FOUND = 0
Frm116_LM_No_ID = vbNullString
